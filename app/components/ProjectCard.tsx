...
export default function ProjectCard({ title, description, link, git, image }: { title: string; description: string; link: string; git?: string; image?: string }) {
  return (
    <div className="project-card">
      ...
      <div className="project-card-content">
        ...
        <div className="project-card-footer">
          ...
          <a href={git} target="_blank" rel="noopener noreferrer" className="project-card-link">
            <GithubIcon />
          </a>
        </div>
      </div>
